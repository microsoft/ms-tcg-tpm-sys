...
pub struct MsTpm185LibraryState {
    opaque: Vec<u8>,
}

pub fn get_runtime_state() -> MsTpm185LibraryState {
    let mut size: u32 = 0;
    ...
    let mut state = MsTpm185LibraryState {
...
pub fn restore_runtime_state(state: MsTpm185LibraryState) -> Result<(), Error> {
